...
Route::group(['middleware'=>'guest'],function(){
    ...
    Route::group(['prefix'=>'/admin','middleware' => 'auth:admin'],function () {
        ...
        Route::group(['middleware' => 'permission:admin'],function () {
            ...
            Route::delete('blog/delete', 'Backend\Admin\PostController@delete')->name('blog.delete');
            ...
            //Promotions
            Route::get('promotions', 'Backend\Admin\PromotionsController@index')->name('admin.promotions');
            Route::get('promotions/create', 'Backend\Admin\PromotionsController@create')->name('promotions.create');
            Route::post('promotions/create', 'Backend\Admin\PromotionsController@store')->name('promotions.store');
            Route::delete('promotions/delete', 'Backend\Admin\PromotionsController@delete')->name('promotions.delete');
            Route::get('promotions/{id}/edit', 'Backend\Admin\PromotionsController@edit')->name('promotions.edit');
            Route::post('promotions-update', 'Backend\Admin\PromotionsController@updatePost')->name('promotions.update');
