...
@section('title',"Promotions Title")
@section('content')
    <!-- <div class="card">
    ...
    <div class="card">
        <div class="card-header bg-white font-weight-bold">
            <h2 >{{$page_title}}
                <a href="{{route('promotions.create')}}" class="btn btn-success btn-md float-right ">
                    <i class="fa fa-plus"></i> Add promotions
                </a>
            </h2>
                ...
                @foreach($posts as $k=>$data)
                    <tr>
                        ...
                        <td data-label="Action">
                            <a href="{{route('promotions.edit',$data->id)}}" class="btn btn-primary  btn-icon btn-pill" title="Edit">
