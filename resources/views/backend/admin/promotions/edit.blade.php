...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-header bg-white font-weight-bold">
            <a href="{{route('admin.promotions')}}" class="btn btn-success btn-md float-right">
                <i class="fa fa-eye"></i> All Promotions
            </a>
        </div>

        <form role="form" method="POST" action="{{route('promotions.update')}}" name="editForm" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="card-footer bg-white">
                <button class="btn btn-primary btn-block btn-lg" type="submit">Update Promotions</button>
            </div>
